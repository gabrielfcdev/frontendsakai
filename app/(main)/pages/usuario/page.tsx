...
const Usuario = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Gerenciamento de Usúarios</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Mostrando {first} até {last} de {totalRecords} usúarios"
                        globalFilter={globalFilter}
                        emptyMessage="Nenhum usúario encontrado."
                        header={header}
                    ...
                    <Dialog visible={usuarioDialog} style={{ width: '450px' }} header="Detalhes do Usúario" modal className="p-fluid" footer={usuarioDialogFooter} onHide={hideDialog}>
                    ...
                    <Dialog visible={deleteUsuarioDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteUsuarioDialogFooter} onHide={hideDeleteUsuarioDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {usuario && (
                                <span>
                                    Você realmente deseja excluir o usúario? <b>{usuario.nome}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
